	...
	<view class="container">
		<view class="page-body">
			<view class='wrapper'>
				...
				<editor id="editor" class="ql-container" placeholder="写点什么吧..." showImgSize showImgToolbar showImgResize
				 @statuschange="onStatusChange" :read-only="readOnly" @ready="onEditorReady" @input="input">
				</editor>
			</view>
		</view>
	...
	export default {
		...
		methods: {
			...
			input: function(e) {
				...
				this.$emit('contentChange', this.detail)
			}
		},
		onLoad() {
			uni.loadFontFace({
